...
class Line(object):
    ...
    def noise_generation(self,
                         lightpath):  # modified here to return the sum of
        # print(type(lightpath))       # ase generation and nli noise
    ...
    def transparency(self):  # recovers loss at each span
...
class Network(object):
    ...
    def stream(self, connections, best='latency'):
        ...
        for connection in connections:
            ...
            # signal_power = connection.signal_power   from here signal power will be calculated using optimizaton method
            ...
            if path:
                ...
                self.optimization(in_lightpath)   # for calculating power of lightpath
    ...
    @staticmethod
    def path_to_line_set(path):   # given the path, return set of lines
        path = path.replace('->', '')
...
streamed_connections = network.stream(connections, best='snr')     # default latency
